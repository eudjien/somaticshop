...
namespace Core
{
    public interface IUnitOfWork
    {
        ...
        IProductSpecificationNameRepository ProductSpecificationNameRepository { get; }
        IProductSpecificationValueRepository ProductSpecificationValueRepository { get; }
