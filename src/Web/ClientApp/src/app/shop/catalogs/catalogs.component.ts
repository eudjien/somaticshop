...
export class CatalogsComponent implements OnInit, OnDestroy {
  ...
  readonly PAGE_NUMBER_QUERY = 'p';
  readonly PAGE_SIZE_QUERY = 'ps';
  readonly SORT_QUERY = 'o';
  readonly BRAND_QUERY = 'b';
  readonly SPECIFICATION_QUERY = 's';

  readonly DEFAULT_PAGE_SIZE = 10;
  readonly DEFAULT_SORT = ProductSort.DateDesc;
  ...
  constructor(
    ...
    this._router.routeReuseStrategy.shouldReuseRoute =
      (a, c) => a.component === c.component && a.params.id === c.params.id;
  ...
  private loadPage(pageIndex = 0, pageSize = 10, search: ProductSearch): void {
    ...
    const res = this._productService.productsPage(pageIndex, search, this.sort, pageSize)
      .pipe(switchMap(page => {
